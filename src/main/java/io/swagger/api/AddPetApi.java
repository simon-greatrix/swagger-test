...
public class AddPetApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "default response", content = @Content(schema = @Schema(implementation = String.class)))
    })
    public Response loadPet(@Valid Pet body) {
