...
@Api(value = "addPet", description = "the addPet API")
public interface AddPetApi {

    @ApiOperation(value = "", nickname = "loadPet", notes = "", response = String.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<String> loadPet(@ApiParam(value = ""  )  @Valid @RequestBody Pet body);
